...
using SkiaSharp;
namespace SkiaLoading.Extensions
{
    public static class BitmapExtensions
    {
        public static SKBitmap LoadBitmapResource(string resourceID)
        {
            Assembly assembly = typeof(BitmapExtensions).Assembly;

            using (Stream stream = assembly.GetManifestResourceStream(assembly.GetName().Name + "." + resourceID))
            {
